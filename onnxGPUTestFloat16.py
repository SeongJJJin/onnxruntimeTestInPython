...
try:
    ...
    providers = [
        ('CUDAExecutionProvider', {
            'device_id': 0, # 해당 로컬은 GPU가 1개라서 첫번째 선택
    ...
    ort_session = ort.InferenceSession("model/bestFloat16IOFix.onnx", providers=providers) # 입출력 텐서 float32
    # ort_session = ort.InferenceSession("model/bestFloat16.onnx", providers=providers) # 입출력 텐서 float16
